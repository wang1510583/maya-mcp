...
from maya_agent.rigs.custom_body.animation import frame_range, Transfer
from maya_agent.rigs.custom_body.targets import CHANNELS


def run_case(count=4, chain=True, fail=False, spin=False, scale_animation=False):
    ...
    prefix = '_CBR_ANIM_' + uuid.uuid4().hex[:8]
    rig = None
