...
from maya_agent.rigs.custom_body.definition import VERSION, RECIPE_PATH
...
with ZipFile(archive) as zipped:
    ...
    assert json.loads(zipped.read(RECIPE_PATH.relative_to(ROOT).as_posix()))['version'] == VERSION
